 ...
 * @author tranp
 */
@WebServlet(name = "RemoveContractController", urlPatterns = {"/RemoveContractController"})
public class RemoveContractController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean check=dao.removeContract(contractID);

 ...
 * @author tranp
 */
@WebServlet(name = "ViewEditContractController", urlPatterns = {"/ViewEditContractController"})
public class ViewEditContractController extends HttpServlet {

    private static final String ERROR="admin.jsp";
    private static final String SUCCESS="admin_contract_edit.jsp";

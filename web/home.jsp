                            ...
                            <nav class="site-navigation text-right text-md-right" role="navigation">
                                ...
                                <ul class="site-menu js-clone-nav d-none d-lg-block">
                                    ...
                                    <li class="has-children">
                                        <a href="apartments.html">Login &nbsp; &nbsp;</a>
                            ...
                            <form action="MainController">
                                ...
                                <div class="inner-form">
                                    <div class="input-field first-wrap">
                                        <input name="searchRoom" required="" value="${param.searchRoom}" id="search" type="text" placeholder="What are you looking for?" />
                                    </div>

                                    <div class="input-field second-wrap"  >
                                        <div class="input-select">
                                            <select  id="sampleSelect" onchange="location = this.value;" data-trigger="" name="choices-single-defaul">
                                                <option>Building</option>
                                                <option value="MainController?action=Filter&buildingID=1"> Block A</option>
                                                <option value="MainController?action=Filter&buildingID=2"> Block B</a></option>
                                                <option value="MainController?action=Filter&buildingID=3"> Block C</option>
                                            </select>
                                    ...
                                    <div class="input-field third-wrap">
                                        <button class="btn-search" type="submit" name="action" value="Find" style="background-color:  #6777ef;border-color:  #6777ef">SEARCH</button>

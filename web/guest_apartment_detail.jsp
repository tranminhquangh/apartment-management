...
<html lang="en">
    ...
    <body>
        ...
        <%    AccountDTO loginAccount = (AccountDTO) session.getAttribute("LOGIN_ACCOUNT");
            ...
            if (loginAccount == null || !loginAccount.getRoleID().equals("GS")) {
                            ...
                            <nav class="site-navigation text-right text-md-right" role="navigation">
                                ...
                                <ul class="site-menu js-clone-nav d-none d-lg-block">
                                    ...
                                    <li class="has-children">
                                        <a href="apartments.html">Hi, <%= loginUser.getFullName()%> &nbsp; &nbsp;</a>
                ...
                <div class="featured-property-half d-flex">
                    ...
                    <div class="text">
                        ...
                        <ul class="property-list-details mb-5">
                            ...
                            <li class="text-black">Property Name: <strong class="text-black">${requestScope.DETAIL_ROOM.roomTitle}</strong></li>
                        ...
                        <input class="btn btn-primary px-4 py-3" type="submit" name="action" value="Buy"/>
                    </div>
                </div>
            </div>
                               </form>

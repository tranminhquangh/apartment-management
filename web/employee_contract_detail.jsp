                ...
                <div class="main-sidebar">
                    <aside id="sidebar-wrapper">
                        <div class="sidebar-brand">
                            <a href="employee_dashboard.jsp">DIPBRO</a>
                        </div>
                    ...
                    <section class="section">
                        <div class="section-header">
                            ...
                            <div class="section-header-breadcrumb">
                                ...
                                <div class="breadcrumb-item"><a href="#">Contract Detail</a></div>
                            </div>
                        </div>
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-6 col-12">
                                                            ...
                                                            <input type="text" class="form-control" value="${requestScope.DETAIL_CONTRACT.contrTitle}" required="">
                                                        ...
                                                        <div class="form-group col-md-6 col-12">
                                                            ...
                                                            <input type="text" class="form-control" value="${requestScope.DETAIL_CONTRACT.contrStatus}" required="">
                                                            <div class="invalid-feedback">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-md-7 col-12">
                                                            ...
                                                            <input type="email" class="form-control" value="${requestScope.DETAIL_CONTRACT.contrNumber}"
                                                                   required="">
                                                            <div class="invalid-feedback">
                                                        ...
                                                        <div class="form-group col-md-5 col-12">
                                                            <label>ID</label>
                                                            <input type="tel" class="form-control" value="${requestScope.DETAIL_CONTRACT.contractID}">
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-6 col-12">
                                                            ...
                                                            <input type="text" class="form-control" value="${requestScope.DETAIL_CONTRACT.contrCreateDate}" required="">
                                                            <div class="invalid-feedback">
                                                                Please fill in the first name
                                                            </div>
                                                        </div>
                                                        <div class="form-group col-md-6 col-12">
                                                            ...
                                                            <input type="text" class="form-control" value="${requestScope.DETAIL_CONTRACT.contrStartDate}" required="">
                                                            <div class="invalid-feedback">
                                                                Please fill in the last name
                                                            </div>
                                                        </div>
                                                        <div class="form-group col-md-6 col-12">
                                                            ...
                                                            <input type="text" class="form-control" value="${requestScope.DETAIL_CONTRACT.contrEndDate}" required="">
                                                            <div class="invalid-feedback">
                                                                Please fill in the last name
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-6 col-12">
                                                            <label>Fee</label>
                                                            <input type="text" class="form-control" value="${requestScope.DETAIL_CONTRACT.contrFee}" required="">
                                                            <div class="invalid-feedback">
                                                                Please fill in the first name
                                                            </div>
                                                        </div>
                                                        <div class="form-group col-md-6 col-12">
                                                            ...
                                                            <input type="text" class="form-control" value="${requestScope.DETAIL_CONTRACT.contrFeeType}" required="">
                                                            <div class="invalid-feedback">
                                                                Please fill in the last name
                                                            </div>
                                                        </div>
                                                        <div class="form-group col-md-6 col-12">
                                                            ...
                                                            <input type="text" class="form-control" value="${requestScope.DETAIL_CONTRACT.contrBillingDate}" required="">
                                                            <div class="invalid-feedback">
                                                                Please fill in the last name
                                                            </div>
                                                        </div>
                                                        <div class="form-group col-md-6 col-12">
                                                            ...
                                                            <input type="text" class="form-control" value="${requestScope.DETAIL_CONTRACT.contrFeeStatus}" required="">
                                                            <div class="invalid-feedback">
                                                                Please fill in the last name
                                                            </div>
                                                        </div>
                                                        <div class="form-group col-md-6 col-12">
                                                            ...
                                                            <input type="text" class="form-control" value="${requestScope.DETAIL_CONTRACT.contrAttachment}" required="">
                                                            <div class="invalid-feedback">
                                                                Please fill in the last name
                                                            </div>
                                                        </div>

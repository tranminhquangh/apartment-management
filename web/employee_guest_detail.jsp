                ...
                <div class="main-sidebar">
                    <aside id="sidebar-wrapper">
                        ...
                        <ul class="sidebar-menu">
                           ...
                           <li class="nav-item dropdown active"><a class="nav-link " href="employee_guest_list.jsp"><i class="fas fa-user" style="margin-left:5px ;"></i> <span>Guest</span></a>
                        </li>
                            <li class="nav-item dropdown ">
                    ...
                    <section class="section">
                        <div class="section-header">
                            ...
                            <div class="section-header-breadcrumb">
                                <div class="breadcrumb-item active"><a href="guest.jsp">Guest</a></div>
                                <div class="breadcrumb-item"><a href="#">Guest Detail</a></div>
                            </div>
                        </div>
